...
int SumOfEachColumn (int arr[3][3], int ColumnNumber, int RowNumber)
{
    int sum = 0;
...
void SaveSumOfEachRowInArray(int OneDimArr[3], int TwoDimArr[3][3], int colums, int rows)
{
    for (int j = 0; j < colums; j++)
    {
        OneDimArr[j] = SumOfEachColumn(TwoDimArr, j, rows);
    }
}
