...
short GetActualVacationDays(stDate Date1, stDate Date2)
{
    short VacationLength = GetDiffInTwoDates(Date1, Date2);
    short WeekEnds = 0;
    ...
    return VacationLength - WeekEnds;
}
...
int main()
{
    ...
    cout << "\n\nVacation From: " << GetDayNameBasedOnIndex(GetDayIndexInWeek(Date1)) << " , ";
    cout << Date1.Day << "/" << Date1.Month << "/" << Date1.Year << endl;
    cout << "Vacation To: " << GetDayNameBasedOnIndex(GetDayIndexInWeek(Date2)) << " , ";
    cout << Date2.Day << "/" << Date2.Month << "/" << Date2.Year << endl;

    cout << "\n\nActual Vacation Days is : " << GetActualVacationDays(Date1, Date2) << endl;
