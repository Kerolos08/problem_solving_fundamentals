...
short ReadUserPermissions()
{
    ...
    else
    {
        ...
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eListClients : 0);
        cout << "\nAdd New Client? y/n? ";
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eAddNewClient : 0);
        cout << "\nDelete Client? y/n? ";
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eDeleteClient : 0);
        cout << "\nUpdate Client? y/n? ";
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eUpdateClientInfo : 0);
        cout << "\nFind Client? y/n? ";
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eFindClient : 0);
        cout << "\nTransactions? y/n? ";
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eTransactions : 0);
        cout << "\nManage Users? y/n? ";
        cin >> YesOrNo;
        Permissions |= (toupper(YesOrNo) == 'Y' ? Permissions | enMainMenuOption::eManageUsers : 0);
    }
    return Permissions;
}
...
void AddUserDataToFile(string FileName)
{
...
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eListClients))
    {
        cout << "-------------------------------------" << endl;
...
void AddUsers()
{
    ...
    do
    {
        ...
        AddUserDataToFile(UsersFileName);
...
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eAddNewClient))
    {
        cout << "-------------------------------------" << endl;
        cout << "Access Denied," << endl;
        cout << "You don't Have Permission to Do this," << endl;
...
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eDeleteClient))
    {
        cout << "-------------------------------------" << endl;
        cout << "Access Denied," << endl;
        cout << "You don't Have Permission to Do this," << endl;
...
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eUpdateClientInfo))
    {
        cout << "-------------------------------------" << endl;
        cout << "Access Denied," << endl;
        cout << "You don't Have Permission to Do this," << endl;
...
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eFindClient))
    {
        cout << "-------------------------------------" << endl;
        cout << "Access Denied," << endl;
        cout << "You don't Have Permission to Do this," << endl;
...
bool IsValidLoginData(stUser User)
{
    vector<stUser> vUsers = LoadUsersRecordFromFile(UsersFileName);
    for (stUser &U : vUsers)
    {
...
stUser LoginSystem()
{
    stUser InputLoginUserData;
    stUser ActiveUser;

    cout << "\n\nEnter Username? ";
    getline(cin >> ws, InputLoginUserData.UserName);
    cout << "\nEnter Password? ";
    getline(cin >> ws, InputLoginUserData.Password);
    while (!IsValidLoginData(InputLoginUserData))
    {
    ...
    FindUserbyUserName(InputLoginUserData.UserName, ActiveUser, UsersFileName);
    return ActiveUser;
}

void ViewLoginScreen(stUser &ActiveUser)
{
    cout << "-------------------------------------------------------------" << endl;
    cout << "\t\tLogin Screen" << endl;
    cout << "-------------------------------------------------------------" << endl;
    ActiveUser = LoginSystem();
    system("cls");
    ViewMainMenuScreen();
}
...
void ViewTransacionsMenu()
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eTransactions))
    {
        cout << "-------------------------------------" << endl;
        cout << "Access Denied," << endl;
        cout << "You don't Have Permission to Do this," << endl;
...
void ViewManageUsersMenu()
{
    if (ActiveUser.Permissions != -1 && !(ActiveUser.Permissions & enMainMenuOption::eManageUsers))
    {
        cout << "-------------------------------------" << endl;
        cout << "Access Denied," << endl;
        cout << "You don't Have Permission to Do this," << endl;
